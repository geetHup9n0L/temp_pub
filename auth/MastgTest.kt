...
class MastgTest(private val context: Context) {
    ...
    class DemoResults(val id: String) {
        private val output = StringBuilder()

        // This mimics the .add(Status, String) method from the images
        fun add(status: Status, message: String) {
            output.append("[$status] $message\n")
        }

        // Allows you to convert the final results to a readable string at the end
